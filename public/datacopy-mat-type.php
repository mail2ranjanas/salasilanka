...
$xml = simplexml_load_file("MAT_TYPE.xml") or die("Error: Cannot create object");

foreach ($xml as $row) {
    $id = $row->MATIRIAL_x0020_TYPR_x0020_ID;
    $type = $row->MATERIAL_x0020_TYPE;
   ...
   // INSERT INTO `materials` (`id`, `MATERIAL_ID`, `MATERIAL_DESCRIPTION`, `MATERIAL_TYPE_ID`, `UNIT_ID`, `KEINBY`, `ReorderQTY`, `SupplyLimit`, `REmaterial`, `CTVprohib`) VALUES (NULL, '1', '1', '1', '1', '1', '1', '1', '1', '1');
    ...
    $sql = "INSERT INTO `material_type` (`id`, `type`)
     VALUES ('$id', '$type')";
    //utf8mb4_unicode_ci
